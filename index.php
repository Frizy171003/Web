...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-nav" id="navbar-nav">
            ...
            <a href="login.php" id="admin-nav">Admin</a>
        </div>

        <div class="navbar-extra">
            <a href="#" id="sidebar-menu"><i data-feather="menu"></i></a>
        </div>
    </nav>
    ...
    <section class="hero" id="home">
        <main class="content">
            <h1>Pelopor <span>Mie Pedas</span> Di Sumbar</h1>
            <p>Cita Rasa Lezat Dengan Harga Bersahabat </p>
